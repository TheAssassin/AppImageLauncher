...
set(CPACK_RPM_PACKAGE_RELEASE "git${APPIMAGELAUNCHER_GIT_COMMIT_DATE_SHORT}.${APPIMAGELAUNCHER_GIT_COMMIT}")

# append build ID, similar to AppImage naming
if(DEFINED ENV{TRAVIS_BUILD_NUMBER})
    set(CPACK_RPM_PACKAGE_RELEASE "travis$ENV{TRAVIS_BUILD_NUMBER}~${CPACK_RPM_PACKAGE_RELEASE}")
else()
